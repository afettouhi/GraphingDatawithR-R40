...
data("ANCdata")
attach(ANCdata)
xtab1 = table(death,anc)   # make this table an object, "xtab1"
xtab1    # show the values in xtab1

mosaic(xtab1) # command operates on table, not original cases
mosaic(~death+anc)
...
mosaic(xtab1)   # produces Figure 20-1
